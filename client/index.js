...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Root = __webpack_require__(456);

	var _Root2 = _interopRequireDefault(_Root);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	(0, _reactDom.render)(_react2.default.createElement(_Root2.default, null), document.getElementById('root')); // for es6 promise required for fetch
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ListPosts = __webpack_require__(457);
	...
	exports.default = _react2.default.createClass({
		...
		refresh: function refresh() {
			...
			(0, _isomorphicFetch2.default)('http://localhost:3000/employees').then(function (req) {
				return req.json();
			}).then(function (json) {
				return _this.setState({ employees: json });
			});
		},
		handleRefreshButton: function handleRefreshButton() {
			this.refresh();
		},
		render: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(_ListPosts2.default, { data: this.state.employees })
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ListItemPost = __webpack_require__(458);

	var _ListItemPost2 = _interopRequireDefault(_ListItemPost);
	...
	exports.default = _react2.default.createClass({
		...
		render: function render() {
			...
			var employeeNodes = data.map(function (employee) {
				return _react2.default.createElement(_ListItemPost2.default, { key: employee.id, data: employee });
			});
